...
namespace CapitoYuliana_ExamenProgreso1.Controllers
{
    public class CelularController : Controller
    {
        ...
        public CelularController(CapitoYuliana_ExamenProgreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Anio,Precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Anio,Precio")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
